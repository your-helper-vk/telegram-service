...
export class CreateVkontakteFriends1688481430647 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('ALTER TABLE "vkontakte_friends" ADD CONSTRAINT "FK_vk_friends_vk_friend" FOREIGN KEY ("vkontakte_friend_user_id") REFERENCES "vkontakte_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION');
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('ALTER TABLE "vkontakte_friends" DROP CONSTRAINT "FK_vk_friends__vk_user"');
        await queryRunner.query('ALTER TABLE "vkontakte_friends" DROP CONSTRAINT "FK_vk_friends_vk_friend"');
